...
#include "formosa-api.h"

#define CRYPTO_PUBLICKEYBYTES VERIFICATION_KEY_SIZE
#define CRYPTO_SECRETKEYBYTES SIGNING_KEY_SIZE
#define CRYPTO_BYTES SIGNATURE_SIZE
